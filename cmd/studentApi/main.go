...
func main() {
	...
	// setup routes for update and delete
	router.HandleFunc("PUT /api/students/{id}", student.UpdateId(storage))
	router.HandleFunc("DELETE /api/students/{id}", student.DeleteId(storage))
