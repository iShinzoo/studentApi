...
func UpdateId(storage storage.Storage) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		id := r.PathValue("id")
		...
		slog.Info("user updated successfully", slog.String("userId", fmt.Sprint(intId)))
		response.WriteJson(w, http.StatusOK, map[string]string{"message": "student updated successfully"})
	}
}

func DeleteId(storage storage.Storage) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		id := r.PathValue("id")
		...
		slog.Info("user deleted successfully", slog.String("userId", fmt.Sprint(intId)))
